...
#
# Modifications 2024 by Letitia Parcalabescu (MM-SHAP): removed a
# `tokenizer_class=_TOKENIZER_FOR_DOC` argument to `add_code_sample_docstrings`,
# which was removed in transformers > 4.11 and only affected generated docs.
"""PyTorch BERT model. """
